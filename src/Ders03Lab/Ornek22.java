 ...
 * @author anizam
 */
public class Ornek22 extends javax.swing.JFrame {
    ...
    public Ornek22() {
        initComponents();
        cbDil.addItem(new Dil("Türkçe","Merhaba"));
        cbDil.addItem(new Dil("?ngilizce","Hi"));
        cbDil.addItem(new Dil("Arapça","Selam"));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ornek22.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
